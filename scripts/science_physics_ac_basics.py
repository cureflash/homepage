"""Formal Physics AC-circuit basic checkpoints.

Covers sinusoidal RMS voltage, a pure-resistor AC circuit, average power in a
pure resistor, and finite-answer AC fundamentals. All numerical relationships
are learner-visible and reuse existing reversible product generation.
"""
...
def _formula_topic(title, skill, formula, result, inputs, variables, seeds, modes):
    return {
        "generator": "formula",
        "title": title,
        "unit": "電気と磁気：交流の基本",
...
PHYSICS_AC_BASICS_TOPICS = {
    "ac-sinusoidal-rms-voltage-numeric": _formula_topic(
        "物理 交流：正弦波交流の実効値",
        "ac-sinusoidal-rms-voltage-numeric",
        "正弦波交流では Vmax=√2 Veff。計算では問題に示す √2≈1.414 を用いる。Vmax[V]、Veff[V]。",
        "peak_voltage",
        ["sqrt2_factor", "rms_voltage"],
        {
            "peak_voltage": {"label": "電圧の最大値 Vmax", "unit": "V"},
            "sqrt2_factor": {"label": "√2 の近似値", "unit": "", "values": _SQRT2_APPROX},
            "rms_voltage": {"label": "電圧の実効値 Veff", "unit": "V", "values": _RMS_VOLTAGE_V},
        },
        _RMS_SEEDS,
        {
            "basic-peak": {"solve_for": "peak_voltage", "worksheet_mode": "calculation-basic", "description": "正弦波交流の実効値から最大値を求めます。"},
            "reverse-rms": {"solve_for": "rms_voltage", "worksheet_mode": "calculation-reverse", "description": "正弦波交流の最大値から実効値を逆算します。"},
        },
    ),
    "ac-resistor-ohm-rms-numeric": _formula_topic(
        "物理 交流：抵抗だけの交流回路",
        "ac-resistor-ohm-rms-numeric",
        "抵抗だけの交流回路では実効値について Veff=Ieff R。Veff[V]、Ieff[A]、R[Ω]。",
        "rms_voltage",
        ["rms_current", "resistance"],
        {
            "rms_voltage": {"label": "電圧の実効値 Veff", "unit": "V"},
            "rms_current": {"label": "電流の実効値 Ieff", "unit": "A", "values": _CURRENT_A},
            "resistance": {"label": "抵抗 R", "unit": "Ω", "values": _RESISTANCE_OHM},
        },
        _RESISTOR_SEEDS,
        {
            "basic-voltage": {"solve_for": "rms_voltage", "worksheet_mode": "calculation-basic", "description": "抵抗だけの交流回路で電圧の実効値を求めます。"},
            "reverse-current": {"solve_for": "rms_current", "worksheet_mode": "calculation-reverse", "description": "電圧の実効値と抵抗から電流の実効値を逆算します。"},
            "reverse-resistance": {"solve_for": "resistance", "worksheet_mode": "calculation-reverse", "description": "電圧・電流の実効値から抵抗を逆算します。"},
        },
    ),
    "ac-resistor-average-power-numeric": _formula_topic(
        "物理 交流：抵抗で消費する平均電力",
        "ac-resistor-average-power-numeric",
        "抵抗だけの交流回路で平均電力は P=Veff Ieff。P[W]、Veff[V]、Ieff[A]。",
        "power",
        ["rms_voltage", "rms_current"],
        {
            "power": {"label": "平均電力 P", "unit": "W"},
            "rms_voltage": {"label": "電圧の実効値 Veff", "unit": "V", "values": _VOLTAGE_V},
            "rms_current": {"label": "電流の実効値 Ieff", "unit": "A", "values": _CURRENT_A},
        },
        _POWER_SEEDS,
        {
            "basic-power": {"solve_for": "power", "worksheet_mode": "calculation-basic", "description": "抵抗で消費する平均電力を実効値から求めます。"},
            "reverse-voltage": {"solve_for": "rms_voltage", "worksheet_mode": "calculation-reverse", "description": "平均電力と電流の実効値から電圧の実効値を逆算します。"},
            "reverse-current": {"solve_for": "rms_current", "worksheet_mode": "calculation-reverse", "description": "平均電力と電圧の実効値から電流の実効値を逆算します。"},
        },
    ),
    "ac-core-concepts": {
        "generator": "retrieval",
