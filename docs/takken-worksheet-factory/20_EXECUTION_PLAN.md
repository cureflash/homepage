...
- [x] `takken-concept-guarantee-association`: 12 verified items covering the statutory guarantee-association system, 600,000/300,000 yen contribution formula, joining/new-office deadlines, association deposit within one week, refund right and limit, association certification, post-refund replenishment, two-week refund charge, loss of membership on nonpayment, member営業保証金 exemption, and the one-week営業保証金 deposit rule after loss of membership. `takken-q-14-001` maps only to the statutory-system item; the other eleven remain explicit Phase 4.3 deficits.
- [x] `takken-concept-brokerage-contract-document`: 13 verified atomic items covering Article 34-2 document delivery, object identification, sale price/exchange valuation, permission for overlapping brokerage/agency, existing-building inspection-arrangement entry, validity/termination, separate REINS and remuneration entries, three contract-type-specific breach-measure entries required by the enforcement regulation, whether standard brokerage terms are used, and consent-based electronic provision. `takken-q-15-001` maps only to the general delivery-duty item; the other twelve remain explicit Phase 4.3 deficits.

Current Phase 4.2 totals: 17/113 modeled concepts, 92 verified knowledge items, 16 existing verified questions mapped, 69 explicit question-coverage gaps.

Exact continuation: `takken-concept-brokerage-price-opinion`, source unit `brokerage-contract-basics`. Preserve all sixty-nine explicit deficits and map existing questions only to knowledge they genuinely test. Do not start Phase 4.3 yet.
