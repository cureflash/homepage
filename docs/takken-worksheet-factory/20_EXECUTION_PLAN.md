...
- [x] The items isolate separate taxation, the January 1 reference date, long-term treatment above five years, and short-term treatment at five years or less.
- [x] Scope remains limited to unit-83's two canonical core facts; residential-property special deductions and unrelated transfer-income rules were not added.
...
Current Phase 4.2 totals: 106/113 concepts with canonical knowledge extraction complete, 105/113 fully reconciled through existing-question mapping, 592 verified knowledge items, 134 existing verified questions mapped, 396 explicit question-coverage gaps.

Exact continuation: reconcile the existing verified unit-83 questions against the 4 `takken-concept-real-estate-transfer-income` knowledge items, mapping only directly measured knowledge. Do not begin Phase 4.3.
