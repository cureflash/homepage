...
- [x] `takken-q-76-001` is mapped only to designation authority and statutory designation grounds, which are directly measured by its stem and four choices.
- [x] Consideration standards, use/profit shift, separately fixed use/profit start date, and unusable-gap compensation remain explicit Phase 4.3 deficits.
...
Current Phase 4.2 totals: 98/113 concepts with canonical knowledge extraction complete, 98/113 fully reconciled through existing-question mapping, 528 verified knowledge items, 121 existing verified questions mapped, 354 explicit question-coverage gaps.

Exact continuation: extract canonical knowledge items for `takken-concept-replotting-disposition`. Do not map `takken-q-76-002` in the same checkpoint. Do not begin Phase 4.3.
