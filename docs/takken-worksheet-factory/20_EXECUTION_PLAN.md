...
- [x] Seven atomic knowledge items now cover the city-planning-area designation authority and integrated-city requirement, cross-municipality designation, quasi-city-planning-area designation authority, outside-city-planning-area scope, land-use/environment-risk criteria, and required predesignation hearing.
- [ ] Existing verified-question reconciliation for `takken-q-61-001` / `takken-q-61-002` remains the next checkpoint; map only directly measured items.

Current Phase 4.2 totals: 79/113 fully reconciled concepts, 80 concepts with canonical knowledge items, 410 verified knowledge items, 90 existing verified questions mapped, 284 explicit question-coverage gaps.

Exact continuation: reconcile `takken-q-61-001` and `takken-q-61-002` only to directly measured `takken-concept-city-quasi-planning-area` knowledge items. Leave the remaining items as explicit Phase 4.3 deficits, then mark the concept complete and advance to the next canonical concept. Keep Phase 4.3 blocked.
