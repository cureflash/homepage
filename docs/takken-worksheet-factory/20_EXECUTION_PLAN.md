...
- [x] `takken-concept-guarantee-association`: 11 verified items covering the statutory guarantee-association system, 600,000/300,000 yen contribution formula, joining/new-office deadlines, association deposit within one week, refund right and limit, association certification, post-refund replenishment, two-week refund charge, loss of membership on nonpayment, and the営業保証金 exemption/one-week restoration rule on loss of membership. `takken-q-14-001` maps only to the statutory-system item; the other ten remain explicit Phase 4.3 deficits.

Current Phase 4.2 totals: 16/113 modeled concepts, 78 verified knowledge items, 15 existing verified questions mapped, 56 explicit question-coverage gaps.

Exact continuation: `takken-concept-brokerage-contract-document`, source unit `brokerage-contract-basics`. Preserve all fifty-six explicit deficits and map existing questions only to knowledge they genuinely test. Do not start Phase 4.3 yet.
