...
- [x] The knowledge set separates land-condition-map classifications and purpose, the general landform/disaster relationship, and representative landforms associated with liquefaction, ground collapse, debris flow/slope failure, flood/internal-water inundation, and storm-surge flooding.
- [x] Existing verified Unit 88 questions remain unmapped in this extraction checkpoint; all 8 new items remain explicit Phase 4.3 deficits until direct-measurement mapping is completed.
...
Current Phase 4.2 totals: 111/113 concepts with canonical knowledge extraction complete, 110/113 fully reconciled through existing-question mapping, 637 verified knowledge items, 144 existing verified questions mapped, 430 explicit question-coverage gaps.

Exact continuation: reconcile the existing verified Unit 88 questions against `takken-concept-landform-disaster-risk`, mapping only directly tested knowledge items. Do not begin Phase 4.3.
