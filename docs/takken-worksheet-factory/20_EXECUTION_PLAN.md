...
- [x] The set separates the 令和8年地価公示 nationwide five-year rise and change in rise-width from the 令和7年度 housing-start total, owner-occupied, rental, and for-sale counts/directions.
- [x] Existing verified Unit 89 questions remain unmapped in this extraction checkpoint; all 6 new items remain explicit Phase 4.3 deficits until direct-measurement mapping is completed.
...
Current Phase 4.2 totals: 112/113 concepts with canonical knowledge extraction complete, 111/113 fully reconciled through existing-question mapping, 643 verified knowledge items, 146 existing verified questions mapped, 433 explicit question-coverage gaps.

Exact continuation: reconcile the existing verified Unit 89 questions against `takken-concept-housing-market-statistics`, mapping only directly tested knowledge items. Do not begin Phase 4.3.
