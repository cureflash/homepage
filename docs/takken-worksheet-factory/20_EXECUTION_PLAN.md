...
Current checkpoint:
- [x] `takken-concept-farmland-article5` has 6 canonical atomic knowledge items sourced to the 2026-04-01 Farmland Act framework and official MAFF guidance.
- [x] Article 5 is separated from Article 4: transfer-for-conversion scope, inclusion of grazing land, permit principle, current permit authority, urbanization-area notification, and Article 4 / Article 5 rights-transfer distinction are explicit knowledge items.
- [x] The current permit-authority rule is represented without the obsolete area threshold: since 2016-04-01, prefectural governors or MAFF-designated municipality mayors exercise conversion-permit authority regardless of conversion area.
- [ ] `takken-q-75-002` has not yet been mapped; evidence reconciliation is the next checkpoint.
...
Current Phase 4.2 totals: 97/113 concepts with canonical knowledge extraction complete, 96/113 fully reconciled through existing-question mapping, 522 verified knowledge items, 119 existing verified questions mapped, 352 explicit question-coverage gaps.

Exact continuation: reconcile verified `takken-q-75-002` against `takken-concept-farmland-article5` and map only knowledge directly measured by its stem and four choices. Do not start `takken-concept-provisional-replotting` in the same checkpoint. Do not begin Phase 4.3.
