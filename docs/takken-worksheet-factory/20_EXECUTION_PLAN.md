...
- [x] `takken-q-58-002` is mapped only to `takken-k-reserved-portion-heirs-excluding-siblings`, the sole knowledge item it directly tests.
- [x] The one-third, one-half, and multiple-heir allocation items remain explicit Phase 4.3 deficits.

Current Phase 4.2 totals: 77/113 completed concepts, 388 verified knowledge items, 86 existing verified questions mapped, 268 explicit question-coverage gaps.

Exact continuation: begin canonical extraction for `takken-concept-condominium-ownership` from source unit `condominium-law`, then reconcile only directly measured existing verified questions. Keep Phase 4.3 blocked.
