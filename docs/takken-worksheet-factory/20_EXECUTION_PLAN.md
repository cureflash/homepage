...
Completed checkpoints through this run: business-definition; license-required; license-authority; license-disqualification; license-validity-renewal; license-transfer; license-change-closure; roster; office-signs; takkenshi-registration; takkenshi-card; exclusive-takkenshi; takkenshi-exclusive-duties; business-guarantee-deposit; business-guarantee-refund; guarantee-association; brokerage-contract-document; brokerage-price-opinion; general-brokerage; exclusive-brokerage; sole-agency-brokerage; reins-registration; brokerage-reporting; advertising-start; contract-start; false-advertising; article35-procedure; article35-items; article37-document; article35-vs-37; eight-restrictions-scope.

Latest checkpoint:
- [x] `takken-concept-eight-restrictions-scope`: 5 verified items. The scope concept separates the self-seller requirement, the non-broker buyer / broker-to-broker exclusion under Article 78(2), exclusion of mere agency/brokerage or self-lease from this self-seller restriction family, the Article 37-2 through 43 regulation family, and the existence of multiple mandatory buyer-protection rules invalidating adverse special terms. Existing `takken-q-25-001` directly tests the regulation-family item and `takken-q-25-002` directly tests the adverse-special-terms item. The other three items remain explicit Phase 4.3 deficits.

Current Phase 4.2 totals: 31/113 modeled concepts, 165 verified knowledge items, 32 existing verified questions mapped, 122 explicit question-coverage gaps.

Exact continuation: `takken-concept-cooling-off`, source unit `cooling-off`. Preserve all one hundred twenty-two explicit deficits and map existing verified questions only to knowledge they genuinely test. Do not start Phase 4.3 yet.
