...
Completed checkpoints through this run: business-definition; license-required; license-authority; license-disqualification; license-validity-renewal; license-transfer; license-change-closure; roster; office-signs; takkenshi-registration; takkenshi-card; exclusive-takkenshi; takkenshi-exclusive-duties; business-guarantee-deposit; business-guarantee-refund; guarantee-association; brokerage-contract-document; brokerage-price-opinion; general-brokerage; exclusive-brokerage; sole-agency-brokerage; reins-registration; brokerage-reporting; advertising-start; contract-start; false-advertising; article35-procedure; article35-items; article37-document; article35-vs-37; eight-restrictions-scope; cooling-off; earnest-money-limit.

Latest checkpoint:
- [x] `takken-concept-earnest-money-limit`: 2 verified items. The concept separates the Article 39 scope (宅建業者自ら売主・買主が宅建業者でない取引) from the statutory 20% cap. Existing `takken-q-27-001` was not mapped because its stem does not state that the buyer is not a宅建業者, while Article 78(2) excludes broker-to-broker transactions from Article 39. Both items remain explicit Phase 4.3 deficits rather than over-claiming existing evidence.

Current Phase 4.2 totals: 33/113 modeled concepts, 176 verified knowledge items, 34 existing verified questions mapped, 131 explicit question-coverage gaps.

Exact continuation: `takken-concept-earnest-money-safeguards`, source unit `earnest-money-and-safeguards`. Preserve all one hundred thirty-one explicit deficits and map existing verified questions only to knowledge they genuinely test. Do not start Phase 4.3 yet.
