...
Completed checkpoints through this run: business-definition; license-required; license-authority; license-disqualification; license-validity-renewal; license-transfer; license-change-closure; roster; office-signs; takkenshi-registration; takkenshi-card; exclusive-takkenshi; takkenshi-exclusive-duties; business-guarantee-deposit; business-guarantee-refund; guarantee-association; brokerage-contract-document; brokerage-price-opinion; general-brokerage; exclusive-brokerage; sole-agency-brokerage; reins-registration; brokerage-reporting; advertising-start; contract-start; false-advertising; article35-procedure; article35-items; article37-document; article35-vs-37; eight-restrictions-scope; cooling-off; earnest-money-limit; earnest-money-safeguards; damages-penalty.

Latest checkpoint:
- [x] `takken-concept-damages-penalty`: 4 verified items. The concept separates statutory scope, combined treatment of scheduled damages and penalties, the 20% cap, and the rule that only the excess portion is invalid. Existing verified `takken-q-28-001` and `takken-q-28-002` omit the buyer-is-not-a-broker condition required to establish Article 38 applicability, so no new mapping was added; all four items remain explicit Phase 4.3 deficits.

Current Phase 4.2 totals: 35/113 modeled concepts, 187 verified knowledge items, 35 existing verified questions mapped, 140 explicit question-coverage gaps.

Exact continuation: `takken-concept-nonconformity-special-rule`, source unit `contract-nonconformity-special-rule`. Preserve all one hundred forty explicit deficits and map existing verified questions only to knowledge they genuinely test. Do not start Phase 4.3 yet.
