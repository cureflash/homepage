...
- [x] `takken-q-62-001` is mapped only to the area-division purpose/two-zone knowledge item it directly measures.
- [x] `takken-q-62-002` is mapped to the three city-area definition knowledge items it directly measures: existing built-up area, approximately-10-year priority/planned urbanization, and urbanization-control-area suppression.
- [x] `takken-concept-area-division` is fully reconciled.

Current Phase 4.2 totals: 81/113 fully reconciled concepts, 81 concepts with canonical knowledge items, 414 verified knowledge items, 94 existing verified questions mapped, 280 explicit question-coverage gaps.

Exact continuation: extract and verify canonical knowledge items for `takken-concept-use-districts` from source unit `use-districts` and primary sources. Do not begin Phase 4.3.
