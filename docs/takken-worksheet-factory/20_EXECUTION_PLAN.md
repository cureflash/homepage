...
Current checkpoint:
- [x] `takken-concept-fixed-asset-tax` has 9 canonical atomic knowledge items grounded in the 2026-04-01 Local Tax Act and current Osaka City official fixed-asset-tax guidance.
- [x] The extraction separates municipal-owner taxation, January 1 assessment date, registered/ledger owner, 1.4% standard rate, exemption thresholds, three-year revaluation, small residential land one-sixth, general residential land one-third, and new-house reduction.
- [x] Existing source question(s) for unit 80 were not mapped in this extraction checkpoint.
...
Current Phase 4.2 totals: 103/113 concepts with canonical knowledge extraction complete, 102/113 fully reconciled through existing-question mapping, 570 verified knowledge items, 128 existing verified questions mapped, 381 explicit question-coverage gaps.

Exact continuation: reconcile the existing verified source question(s) for `takken-concept-fixed-asset-tax` against its 9 knowledge items and map only knowledge directly measured by the stem and four choices. Do not begin Phase 4.3.
