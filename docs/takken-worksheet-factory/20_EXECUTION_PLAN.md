...
Current checkpoint:
- [x] `takken-concept-land-price-public-notice` has 10 canonical knowledge items grounded in the current e-Gov 地価公示法 and Ministry of Land, Infrastructure, Transport and Tourism land-price-public-notice guidance.
- [x] The items isolate the January 1/unit-area price, normal-price definition, vacant-land assumption, Land Appraisal Committee authority, two-or-more appraisers, three appraisal methods, Official Gazette publication, transaction indicator duty, appraisal benchmark, and public-project acquisition benchmark.
...
Current Phase 4.2 totals: 107/113 concepts with canonical knowledge extraction complete, 106/113 fully reconciled through existing-question mapping, 602 verified knowledge items, 136 existing verified questions mapped, 403 explicit question-coverage gaps.

Exact continuation: reconcile the existing verified unit-84 questions against the 10 `takken-concept-land-price-public-notice` knowledge items, mapping only directly measured knowledge. Do not begin Phase 4.3.
