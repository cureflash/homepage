...
Current checkpoint:
- [x] `takken-q-80-001` maps only to `takken-k-fixed-asset-tax-municipal-owner-tax`, the owner-tax principle directly measured by its stem and four choices.
- [x] `takken-q-80-002` maps only to `takken-k-fixed-asset-tax-assessment-date-january1`, the January 1 assessment date directly measured by its stem and four choices.
- [x] The other 7 fixed-asset-tax knowledge items remain explicit Phase 4.3 deficits because the existing questions do not directly measure them.
...
Current Phase 4.2 totals: 103/113 concepts with canonical knowledge extraction complete, 103/113 fully reconciled through existing-question mapping, 570 verified knowledge items, 130 existing verified questions mapped, 379 explicit question-coverage gaps.

Exact continuation: extract and source-check canonical atomic knowledge items for `takken-concept-registration-license-tax`, then defer its existing source-question mapping to the following checkpoint. Do not begin Phase 4.3.
