...
Completed checkpoints through this run: business-definition; license-required; license-authority; license-disqualification; license-validity-renewal; license-transfer; license-change-closure; roster; office-signs; takkenshi-registration; takkenshi-card; exclusive-takkenshi; takkenshi-exclusive-duties; business-guarantee-deposit; business-guarantee-refund; guarantee-association; brokerage-contract-document; brokerage-price-opinion; general-brokerage; exclusive-brokerage; sole-agency-brokerage; reins-registration; brokerage-reporting; advertising-start; contract-start; false-advertising; article35-procedure; article35-items; article37-document; article35-vs-37; eight-restrictions-scope; cooling-off; earnest-money-limit; earnest-money-safeguards; damages-penalty; nonconformity-special-rule.

Latest checkpoint:
- [x] `takken-concept-nonconformity-special-rule`: 5 verified items. The concept separates Article 40 applicability, its direct coverage of kind/quality nonconformity, the general prohibition on terms less favorable to the buyer than Civil Code Article 566, the permitted term of at least two years from delivery, and invalidity of a term violating Article 40. Existing verified `takken-q-29-001` and `takken-q-29-002` omit the buyer-is-not-a-broker condition required to establish Article 40 applicability, so no new mapping was added; all five items remain explicit Phase 4.3 deficits.

Current Phase 4.2 totals: 36/113 modeled concepts, 192 verified knowledge items, 35 existing verified questions mapped, 145 explicit question-coverage gaps.

Exact continuation: `takken-concept-unowned-property-sale`, source unit `unowned-property-restriction`. Preserve all one hundred forty-five explicit deficits and map existing verified questions only to knowledge they genuinely test. Do not start Phase 4.3 yet.
