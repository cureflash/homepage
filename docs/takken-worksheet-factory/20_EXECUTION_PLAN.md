...
- [x] The extraction separates taxpayer/prefectural levy, acquisition regardless of registration/payment, inheritance non-taxation, tax base, the land one-half tax-base special rule, current rates, 2026-04-01 exemption thresholds, new-house deduction, long-life-quality-house deduction, and residential-land reduction.
- [x] The 2026-04-01 rule changes are recorded explicitly rather than reusing pre-April 2026 exemption or floor-area figures.
- [x] Existing source questions `takken-q-79-001` and `takken-q-79-002` were not mapped in this extraction checkpoint.
...
Current Phase 4.2 totals: 102/113 concepts with canonical knowledge extraction complete, 101/113 fully reconciled through existing-question mapping, 561 verified knowledge items, 126 existing verified questions mapped, 379 explicit question-coverage gaps.

Exact continuation: reconcile `takken-q-79-001` and `takken-q-79-002` against `takken-concept-real-estate-acquisition-tax` and map only knowledge directly measured by each stem and four choices. Do not begin Phase 4.3.
