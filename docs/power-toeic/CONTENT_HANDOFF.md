...
- `p5.vocab.adjective_noun_collocation` 0051-0075: 25 questions; the micro-skill is now 75/100.
- Answer positions: A/B/C/D = 7/6/6/6.
- Exact duplicate stems: 0.
- SequenceMatcher similarity >= 0.94: 0; maximum approximately 0.585.
- Full cross-bank semantic duplicate clearance remains outstanding.

The new items vary office policy, auditing, maintenance, finance, retail, property, research, insurance, marketing, logistics, procurement, security, hiring, and customer-service contexts while targeting adjective+noun lexical combinations.

## This run — independent QA

Reviewed the oldest 25 unchecked pending questions in strict backlog order.

- `p5.rel.whose` 0026-0050: 25 checked / 25 verified / 0 needs_revision / 0 rejected.
...
Continue `p5.vocab.adjective_noun_collocation` at `p5_vocab_adjective_noun_collocation_0076`.

## Next QA

Continue the oldest unchecked backlog at `p5_rel_whose_0051`.
