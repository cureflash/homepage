...
### `p5.verb.to_infinitive_pattern` 0026-0050
...
All 25 questions independently resolve to the to-infinitive after the governing verb. Some business contexts are formulaic, but each displayed sentence is grammatically acceptable and none of the alternative forms is defensible in the displayed structure. Every stored proposed answer and explanation agrees with the independently selected answer.
