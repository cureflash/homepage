...
- Needs revision: 91
- Rejected: 0
- Unchecked `pending_validation`: 450
...
- `p5.vocab.verb_noun_collocation` 0051-0100: 50 checked / 50 verified / 0 needs_revision / 0 rejected.
- `p5.vocab.adjective_noun_collocation` 0001-0050: 50 checked / 50 verified / 0 needs_revision / 0 rejected.

No new ambiguous, multiple-answer, or unnatural items were found in these 100 questions.
...
Continue at `p5_vocab_adjective_noun_collocation_0051`.
