...
## p.136 VMD initiatives blocker
Audit: `docs/power-color/audits/2026-09-04-grade1-p136-vmd-initiatives-source-audit.md`.
Classification: `SOURCE_BLOCKED`.
JAVMA/Sugino establish broad VMD practice but not the AFT p.136-specific closed initiative set, sequence, responsibilities, terminology or decision rules. Do not duplicate the p.133 basic-concept skill or import generic VP/PP/IP/process rules without new explicit authority. No authoring.

## p.137 product-display color coordination blocker
Audit: `docs/power-color/audits/2026-09-04-grade1-p137-product-display-color-coordination-source-audit.md`.
Classification: `SOURCE_BLOCKED`.
Public VMD authority confirms color arrangement is used in display practice but does not expose the AFT p.137 deterministic hue/tone/area/grouping/evaluation rule set. No visual or monitor-facing inference; no authoring.

## p.140 landscape-law accepted boundary
Audit: `docs/power-color/audits/2026-09-04-grade1-p140-landscape-law-basics-source-audit.md`.
