...
- [x] Add and pass the dedicated nonvisual/full-fingerprint/shared-renderer authoring gate and normal shared-engine regression; workflow run `33648021940`, PR #548 merged.
