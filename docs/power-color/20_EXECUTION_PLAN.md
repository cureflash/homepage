...
- [ ] Generate the remaining conventional-color questions.
  ...
  - [x] `name_to_color` checkpoint 0033-0040: 8 generated as pending first and independently verified; 0 pending. Targets c3-022..029.
  - [ ] Continue `name_to_color` authoring at question 0041 with c3-conventional-030 カーマイン.
