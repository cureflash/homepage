...
- [x] Complementary hue.
  - [x] Define `pc3.pccs.complementary_hue_number` using the source-confirmed 24-position hue circle.
...
- [x] Same tone.
  ...
  - [x] Generate 12 pending-first questions covering all 12 source-confirmed chromatic tones and independently verify them.
  - [x] Promote record-identically; runtime reached 151 verified / pending 0.
  - [x] Root-fix stale runtime-total assertions so the conventional gate owns its immutable 127-question slice while skill promotion gates own their own records.
- [x] Same hue.
  - [x] Define `pc3.relation.same_hue` from the official PCCS notation rule: hue number is the hue identity while tone may differ.
  - [x] Generate and independently verify 12 pending-first text-only questions with A/B/C/D = 3/3/3/3 and no monitor dependency.
  - [x] Promote record-identically with shared Power TOEIC session/workout/question-bank regression; runtime reached 163 verified / pending 0.
- [ ] Hue difference.
  ...
  - [x] Add authoring gate for source refs, circular derivation, 1-12 coverage, unique choices, pending-first history and text-only feedback.
