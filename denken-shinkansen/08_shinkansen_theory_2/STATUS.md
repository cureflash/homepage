...
- next_start: Topic 20 PowerPoint生成待ち
...
- [ ] 解説画像PowerPoint＋表示QA: `BUILD_PENDING`
- [ ] 完成後独立再解答
- [ ] 最終QA
- [ ] completed状態同期
...
`BUILD_PENDING / topic_20_powerpoint_build_pending / IN_PROGRESS`。

完成数は `19 / 21`。次工程はPowerPoint生成待ち。
