...
Topic 18の制作前EXAM_ALIGNMENTを完了。固定一次5問・25答案要素を確定し、正答保存0件、二次採用0問・二次数合わせ0件。次工程は固定5問・25答案要素の制作前blind独立再解答。
...
Topic 18の固定一次5問・25答案要素を、公式標準解答・保存済み正答を先に見ずに独立再解答する。答案要素ごとに根拠を記録し、その後に公式標準解答と照合する。