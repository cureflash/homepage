...
- next_start: Topic 05の固定EXAM_ALIGNMENTを維持して、解説本文＋基礎・本試験標準・複合の3段階例題を作成する。仕様外論点・未確認実車値は追加しない
...
- [ ] 05 誘導電動機はなぜ勝手に回る？ — 制作前EXAM_ALIGNMENT完了。公式過去問5問・6小問を固定し、制作前独立検証 `6 / 6 PASS`。本文以降は未着手
- [ ] 06〜16 — 未完了
...
## 次
Topic 05の固定EXAM_ALIGNMENTを維持して、解説本文＋基礎・本試験標準・複合の3段階例題を作成する。系列SPECの固定範囲から外れる論点・未確認実車値は追加しない。