...
- next_start: Topic 06の完成後独立再解答を、固定EXAM_ALIGNMENT 5問・7小問について完成教材だけで実施する。固定範囲外知識で補完した場合は正答でもFAILとする
...
- [ ] 06 新幹線はどうやって速度を変えている？ — EXAM_ALIGNMENT、解説本文、3段階例題、解説PDF、練習問題source、練習PDF、解説画像PowerPointまで完了
- [ ] 07〜16 — 未完了
