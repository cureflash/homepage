...
- next_start: Topic 02 の練習問題を12問以上作成する。三種仕様の基礎20〜30%、本試験標準50〜60%、複合・応用約20%、半数以上五肢択一を守り、各問に完全解説を付ける
...
- [ ] 02 初代0系はどうやって走っていた？ — 制作前EXAM_ALIGNMENT、解説本文、3段階例題、解説PDFまで完了。R8上問1・2、R7下問1・2、R7上問1・2の要求事項を本文各節へマッピング済み。練習問題・練習PDF、PowerPoint、完成後独立再解答は未実施
- [ ] 03〜16 — 未着手
...
## 02 QA判定
制作前 `EXAM_ALIGNMENT`、解説本文・3段階例題、解説PDFまで完了。解説PDFはA4縦4ページを全ページレンダリングし、数式・改ページ・可読性をQAしてPASS。テーマ自体は未完了で、練習問題・練習PDF・PowerPoint・完成後独立再解答が残る。完成数は1/16のまま。

## 次
Topic 02 `初代0系はどうやって走っていた？` の練習問題を作成する。原則12問以上、基礎20〜30%、本試験標準50〜60%、複合・応用約20%、半数以上を五肢択一とし、数値問題は使用公式・選定理由・代入・中間計算・最終値・検算まで、知識問題は正答理由と重要誤答肢の誤りまで説明する。選定6問の要求事項を外さず、未確認の実車値やTopic 03の速度制御体系は追加しない。