...
- next_start: Topic 10の練習問題source 12問を練習PDFへ反映し、全ページ表示QA・文字抽出QAを行う
...
- [ ] 10 新幹線の速度はどう自動制御される？ — 解説source＋解説PDF＋練習問題source完成・固定5件接続 `5 / 5`
- [ ] 11〜16 — 未完了
...
R7上問13、R6下問13、R6上問13、R5下問13、R5下問18(b)、R4上問15(b)は、自動制御に関連するが、行過ぎ量、PID、シーケンス制御・インタロック・タイムチャート、ボード線図、比例プラス積分要素、ベクトル軌跡等のTopic 10固定範囲外を正答に必要とするため、全部または該当小問を除外する。
...
## Topic 10 成果物・品質状態
### 解説source
`topics/10_automatic_control/10_automatic_control.md`
...
### 練習問題source
`topics/10_automatic_control/10_automatic_control_practice.md`

- 全12問・全問五肢択一
- 基礎3／本試験標準7／複合・応用2
- 固定EXAM_ALIGNMENT 5件へ `5 / 5` 接続
...
### 解説PDF
`topics/09_regenerative_braking/09_regenerative_braking_explanation.pdf`
...
### 解説PDF QA記録
`topics/09_regenerative_braking/09_regenerative_braking_explanation_pdf_qa.md`

### 練習問題source
`topics/09_regenerative_braking/09_regenerative_braking_practice.md`
...
### 解説画像PowerPoint
`topics/09_regenerative_braking/09_regenerative_braking_images.pptx`
