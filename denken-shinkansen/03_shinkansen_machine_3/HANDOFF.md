...
- このテーマで電験が問う内容と回路判定の入口
- ダイオード、サイリスタ、GTO、IGBTの制御性
- 整流器・コンバータ、インバータ、直流チョッパの分類
- R-L負荷と環流ダイオード
- 三相ダイオード全波整流の6パルス、`V_LL=√3V_s`、最大・最小・平均値、指定脈動率
- チョッパの `T=1/f_s`、`D=t_on/T`、`Vavg=DE`
- 単相ブリッジ電圧形インバータのIGBT/逆並列ダイオード通流経路と `τ=L/R`
- PWM・VVVFと `Ns=120f/P`
- 系列SPEC範囲だけを使った新幹線への接続
- 本試験用解法アルゴリズム、頻出ミス、公式まとめ
- 3段階例題
