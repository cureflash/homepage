...
## 今回進捗
Topic 09「新幹線はどうやって電気で止まる？」の解説本文＋3段階例題を完成した。
...
解説sourceの `P=Fv`、`P=Tω`、`ω=2πN/60`、`E=mv²/2`、`E=Jω²/2`、`P=ΔE/t`、効率、発電制動と回生制動の差、誘導機の負の滑りによる発電機運転、四象限運転の概念、3段階例題、固定5問マッピングを維持する。固定範囲外論点や未確認実車値を追加しない。
