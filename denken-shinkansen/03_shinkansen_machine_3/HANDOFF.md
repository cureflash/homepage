...
Topic 15は制作前 `EXAM_ALIGNMENT`、解説source本文、解説PDF、練習問題sourceまで完了。固定7問・12答案要素は変更せず、本文マッピング `12 / 12 PASS`、練習問題→固定EXAM_ALIGNMENT接続 `12 / 12 PASS`。練習問題は12問（基礎3 / 本試験標準7 / 複合・応用2）、全12問を五肢択一とし、独立計算・論理QA `12 / 12 PASS`、正答一意性QA `12 / 12 PASS`。光束発散度、熱伝導・熱放射、工業電熱、未確認の新幹線車内設備実値、Topic 16は追加していない。

状態: `topic_15_practice_source_complete / IN_PROGRESS`
...
## 次工程
固定EXAM_ALIGNMENTを変更せず、Topic 15の練習PDFを作成する。練習問題sourceの12問を正本とし、表示QA・文字抽出QA・固定7問12答案要素へのマッピングを確認する。