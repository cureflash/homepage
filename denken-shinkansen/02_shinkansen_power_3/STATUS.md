...
- next_start: Topic 10解説本文＋3段階例題を作成する
...
- [ ] 10 新幹線が突然大電力を使ったら？ — 制作前EXAM_ALIGNMENT完了。固定5問・8小問、制作前独立検証 `8 / 8 PASS`、公式解答不一致0件、既完了Topic固定過去問との重複0件
...
## 次
Topic 10 `新幹線が突然大電力を使ったら？` の解説本文＋基礎・本試験標準・複合の3段階例題を作成する。