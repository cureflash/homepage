...
- [ ] 09 変電所からパンタグラフまでどう送る？ — 制作前EXAM_ALIGNMENT完了。固定5問・7小問、独立検証 `7 / 7 PASS`。解説本文§1〜§14＋3段階例題、解説PDF、練習問題source完成。練習sourceは12問・全問五肢択一、数値・論理・正答一意性 `12 / 12 PASS`
- [ ] 10 新幹線が突然大電力を使ったら？
...
## 次
Topic 09 `変電所からパンタグラフまでどう送る？` の練習PDFを作成する。