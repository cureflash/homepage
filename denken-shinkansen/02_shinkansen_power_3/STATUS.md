...
- next_start: Topic 03の解説本文と3段階例題を作成する。制作前EXAM_ALIGNMENTの6問・7小問を教材だけで解ける中間知識を欠落させず、`SPEC.md` の固定範囲から追加しない
...
- [ ] 03 JR東日本はなぜ火力発電所まで持っている？ — 制作前EXAM_ALIGNMENT完了、本文以降は未着手
- [ ] 04〜16 — 未着手
...
- JR東日本川崎発電所等の実設備値は一次資料確認前に真値化しない

## 次
Topic 03の解説本文と3段階例題を作成する。制作前EXAM_ALIGNMENTの6問・7小問を教材だけで解ける中間知識を欠落させず、`SPEC.md` の固定範囲から追加しない。