...
- current_status: `topic_14_preproduction_independent_verification_complete`
- last_completed_topic: `13 新幹線の架線は何でできている？`
- active_topic: `14 駅やトンネルにはどう電気を配る？`
- next_start: Topic 14の固定5問・6答案要素を本文へマッピングし、解説本文と3段階例題（基礎・本試験標準・複合）を作成する
...
- [ ] 14 駅やトンネルにはどう電気を配る？ — 制作前EXAM_ALIGNMENT・制作前独立検証完了。固定5問・6答案要素 `6 / 6 PASS`。次は解説本文
- [ ] 15 回生した電気はどこへ行く？
...
## 次
Topic 14の固定5問・6答案要素を本文へマッピングし、解説本文と3段階例題（基礎・本試験標準・複合）を作成する。