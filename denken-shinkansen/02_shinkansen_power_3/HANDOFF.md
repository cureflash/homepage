...
- 16:9・7枚
- Slide 1: 電験で問われる4本柱、「むつ」確認済み実在仕様、架空部分の境界
- Slide 2: 質量欠損、`E=Δmc²`、石炭相当量計算
- Slide 3: U-235連鎖反応、制御棒、原子炉と汽力発電の対応
- Slide 4: PWR/BWR系統差、「むつ」PWR実在値
- Slide 5: 原子力用蒸気タービン、熱効率、蒸気量、回転速度
- Slide 6: U-235割合→質量欠損→核分裂熱→発電端電力量の複合計算
- Slide 7: 解法アルゴリズム、頻出ミス、選定過去問対応
- 全7枚を1600×900相当でレンダリングし目視確認
