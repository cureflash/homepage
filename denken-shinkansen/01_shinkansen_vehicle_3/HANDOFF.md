...
- 練習PDF: A4縦4ページ / 180 dpi表示 `4 / 4 PASS` / 文字抽出 `PASS`
- Q1〜Q15問題・正答・解説整合: `15 / 15 PASS`
- 固定公式過去問: `5問・5答案要素`
...
固定R6下 機械 問14、R6上 機械 問14、R6下 電力 問9、R4下 電力 問13、R3 電力 問13の5答案要素を練習PDFへも接続した。
...
- source/練習source/PDF内の信頼度例は独立故障を仮定した学習用仮定値であり、COSMOSや新幹線電力設備の実信頼度とは扱わない。
...
## 次の正確な開始点
Topic 38の解説画像PowerPointを制作する。固定5問・5答案要素を可視化へ接続し、16:9表示、スライド外overflow、文字切れ・重なり、PPTX ZIP整合性をQAする。完成後blind独立再解答・最終QAにはまだ進まない。
