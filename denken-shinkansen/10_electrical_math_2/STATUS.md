...
解説PDFはA4縦3ページ。200 dpiで全3ページを確認し `3 / 3 PASS`、欠け・重なり・黒塗り・文字化け0件、`pdftotext -layout` 文字抽出 `PASS`。固定第二種4問・8答案要素への接続 `8 / 8`、3段階例題 `3 / 3` を維持した。第一種・第三種による件数水増し、Topic 17以降の先取り、高次数値計算法等の仕様外追加、未確認実車値依存はいずれも0件。
