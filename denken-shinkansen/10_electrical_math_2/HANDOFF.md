...
current_status: `topic_07_preproduction_reanswer_complete`
...
制作前EXAM_ALIGNMENTと制作前独立再解答・公式解答照合まで完了。解説本文は未実施。
...
- 固定一次5問・22小問の要求事項を本文へ全件マッピングする
- 変数分離、一階線形方程式、初期条件、指数応答、時定数、RC/RL、一次遅れをSPEC範囲内で説明する
- Topic 08以降の二階常微分方程式、ラプラス変換、伝達関数を先取りしない
- 未確認実車値を追加しない