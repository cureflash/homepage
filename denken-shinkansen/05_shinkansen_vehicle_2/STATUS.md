...
- next_start: Topic 12の進捗記録4箇所だけを実成果物へ同期
...
- [ ] 12 300系③ VVVFインバータと誘導機制御 — FINAL_QA_NEEDS_PROGRESS_SYNC / IN_PROGRESS
...
- 要修正: 主source冒頭状態欄、主source末尾次工程、練習source末尾次工程、練習PDF QA末尾のcurrent_status/次工程
