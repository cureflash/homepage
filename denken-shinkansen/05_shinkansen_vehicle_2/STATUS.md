...
- next_start: Topic 27の練習source作成。固定5問・23答案要素と解説PDFを入力として一次試験型＋二次記述式を作成し、数値・論理を独立再計算する。L0系未確認実車値を真値化しない
...
Topic 01〜26: `PASS / completed`。完成数 `26 / 39`。Topic 27は解説PDF完了、次は練習source作成・独立再計算。