...
- current_status: `topic_02_practice_content_complete`
- last_completed_topic: `01 新幹線を電力系統から見てみる`
- active_topic: `02 信濃川の水で新幹線を何本走らせられる？`
- next_start: Topic 02 の練習問題15問を問題文だけから独立再計算・再判定し、一意解・数値・解説整合をQAする
...
次段階では保存済み解答を先に見ず、15問を独立再計算・再判定して一意解と完全解説の整合を確認する。
...
## 次
Topic 02 `信濃川の水で新幹線を何本走らせられる？` の練習問題15問を、保存済み解答を先に見ず独立再計算・再判定する。一意解、数値、単位、記述採点要点と完全解説の整合を確認し、仕様外論点は追加しない。