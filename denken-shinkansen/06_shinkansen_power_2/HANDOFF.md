...
解説PDFはA4縦5ページ。本文§1〜§15＋3段階例題を反映し、200 dpi表示QA `5 / 5 PASS`、文字抽出QA PASS、例題独立再計算 `3 / 3 PASS`、正式4問・17答案要素 `17 / 17` を維持した。固定10項目 `10 / 10`、Topic 11以降補完0件、固定範囲外追加0件、未確認実設備値追加0件、仕様追加0件。
