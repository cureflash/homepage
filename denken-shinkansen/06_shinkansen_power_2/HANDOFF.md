...
状態: `topic_02_practice_content_complete`
...
Topic 02 `信濃川の水で新幹線を何本走らせられる？` の練習問題15問を、問題文だけから独立に再計算・再判定する。

- 保存済み解答を先に見ず、一意解を確認する。
- 数値、単位、選択肢、記述採点要点と完全解説の整合を確認する。
- 正式選定6問の要求事項が問題マッピングから欠落していないことを再確認する。
- 固定範囲外の論点は追加しない。