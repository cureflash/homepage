...
状態: `topic_02_explanation_pdf_complete`
...
Topic 02 `信濃川の水で新幹線を何本走らせられる？` の練習PDFを作成する。

- `02_hydropower_practice.md` の15問と完全解説を同期する。
- 一次型10問＋二次記述型5問の構成を維持する。
- 問題マッピングと既存15/15 QA結果に矛盾させない。
