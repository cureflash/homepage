  ...
  const Q = [
    {
      ...
      choices: ["相手方が契約の履行に着手するまでは、手付を放棄して解除できる", "契約締結後24時間以内に限り解除できる", "売主が履行に着手した後でも常に解除できる", "裁判所の許可を受けた場合に限り解除できる"],
      proposedAnswerIndex: 0,
      explanation: "民法557条により、相手方が契約の履行に着手するまでは、買主は手付を放棄して契約を解除できる。",
      sourceIds: ["egov-civil-code-20260401"],
      validationStatus: "verified",
      validationMeta: { checkedAt: "2026-08-27T23:45:00+09:00", result: "verified" }
    },
    {
      id: "takken-q-48-002",
      unitId: "sale-earnest",
      ...
      choices: ["受領した手付と同額を返還するだけでよい", "手付の倍額を現実に提供する", "手付の3倍額を供託する", "違約金として代金の20%を支払う"],
    ...
    },
    {
      ...
      choices: ["必ず契約を無効にすることだけ", "刑事罰を科すこと", "修補・代替物の引渡し・不足分の引渡しによる履行の追完", "所有権を自動的に第三者へ移転すること"],
    ...
    },
    {
      ...
      choices: ["追完を求めず常に全額返還を請求する", "不適合があっても代金減額は一切できない", "裁判所の確定判決がなければ請求できない", "相当期間を定めて追完を催告し、その期間内に追完がないとき、不適合の程度に応じて請求できる"],
    ...
    },
    {
      ...
      choices: ["賃貸人が物を使用・収益させ、賃借人が賃料を支払い、終了時に物を返還する契約である", "賃借人が所有権を取得することを必須とする契約である", "賃料を支払わない無償契約に限られる", "契約終了後も返還義務はない"],
      proposedAnswerIndex: 0,
    ...
    },
    {
      ...
      choices: ["契約締結直後に全額返還する", "賃借人の未払債務があっても控除できない", "賃貸借終了・目的物返還後などに、未払債務を控除した残額を返還する", "敷金はどのような場合も返還しない"],
      proposedAnswerIndex: 2,
    ...
    },
    {
      ...
      choices: ["必ず賃借権の登記が必要である", "公正証書の作成だけで足りる", "固定資産税の納付が必要である", "建物の引渡しがあれば、登記がなくても対抗できる"],
      proposedAnswerIndex: 3,
    ...
    },
    {
      ...
      choices: ["原則30年で、契約でこれより長い期間を定めたときはその期間となる", "原則10年で延長できない", "原則20年である", "必ず50年以上でなければならない"],
      proposedAnswerIndex: 0,
    ...
    },
    {
      ...
      choices: ["土地の固定資産税を納付する", "土地上に借地権者名義で登記された建物を所有する", "口頭で第三者へ通知する", "地主の印鑑証明書を所持する"],
      proposedAnswerIndex: 1,
    ...
    },
    {
      ...
      choices: ["存続期間は10年以上で設定する", "更新を排除する特約は認められない", "存続期間を50年以上として設定し、更新等がなく建物買取請求をしない旨を定めることができる", "存続期間を1年以上とすれば自由に設定できる"],
      proposedAnswerIndex: 2,
    ...
    },
    {
      ...
      choices: ["口頭だけでなければならない", "当事者の黙示の合意で足りる", "市町村長の許可だけで足りる", "書面または所定の電磁的記録によって行う必要がある"],
      proposedAnswerIndex: 3,
    ...
    },
    {
      ...
      choices: ["建物の引渡しがあれば、登記がなくてもその後に物権を取得した者に対抗できる", "必ず賃借権登記がなければ対抗できない", "賃料を1年分前払いした場合だけ対抗できる", "公証人の認証が必要である"],
      proposedAnswerIndex: 0,
    ...
    },
    {
      ...
      choices: ["契約は当然に無効となる", "期間の定めがない建物賃貸借とみなされる", "必ず1年間の契約とみなされる", "定期建物賃貸借とみなされる"],
      proposedAnswerIndex: 1,
    ...
    },
    {
      ...
      choices: ["必ず契約更新がある", "口頭契約でのみ成立する", "書面等で契約し、更新がなく期間満了で終了する旨を定めることができる", "期間の定めを設けることはできない"],
      proposedAnswerIndex: 2,
    ...
    },
    {
      ...
      choices: ["契約後に口頭説明すれば足りる", "説明は一切不要である", "賃借人が宅建士なら必ず不要である", "賃貸人が契約締結前に更新がなく期間満了で終了する旨を書面等で説明しないと、その旨の定めは無効となる"],
      proposedAnswerIndex: 3,
    ...
    },
    {
      ...
      choices: ["配偶者は常に相続人となり、血族は子、直系尊属、兄弟姉妹の順に相続人となる", "兄弟姉妹は常に配偶者より先に相続する", "直系尊属は子がいる場合でも必ず共同相続人となる", "配偶者は子がいると相続人にならない"],
      proposedAnswerIndex: 0,
    ...
    },
    {
      ...
      choices: ["配偶者3分の2、子全体3分の1", "配偶者2分の1、子全体2分の1", "配偶者4分の3、子全体4分の1", "配偶者3分の1、子全体3分の2"],
      proposedAnswerIndex: 1,
    ...
    },
    {
      ...
      choices: ["相続開始の日から1か月", "被相続人の死亡から1年", "自己のために相続開始があったことを知った時から3か月", "相続財産を知った時から6か月"],
      proposedAnswerIndex: 2,
    ...
    },
    {
      ...
      choices: ["市町村長へ届け出る", "法務局に登記申請する", "他の相続人へ口頭で伝えれば足りる", "家庭裁判所に申述する"],
      proposedAnswerIndex: 3,
    ...
    },
    {
      ...
      choices: ["遺言者の死亡時", "遺言書を作成した時", "公証人が保管した時", "相続人全員が同意した時"],
      proposedAnswerIndex: 0,
    ...
    },
    {
      ...
      choices: ["兄弟姉妹だけである", "兄弟姉妹以外の相続人である", "すべての法定相続人に必ずある", "配偶者には遺留分がない"],
      proposedAnswerIndex: 1,
    ...
    },
    {
      ...
      choices: ["一棟の建物はどのような場合も分けて所有できない", "廊下や階段だけが専有部分になる", "構造上区分され、独立して住居・店舗等の用途に供することができる部分は所有権の目的とすることができる", "敷地だけが区分所有権の対象となる"],
      proposedAnswerIndex: 2,
    ...
    },
    {
      ...
      choices: ["管理会社だけの所有となる", "最上階の区分所有者だけの所有となる", "市町村の所有となる", "区分所有者全員の共有に属する"],
      proposedAnswerIndex: 3,
    ...
    },
    {
      ...
      choices: ["表題部には表示に関する登記が、権利部には権利に関する登記が記録される", "表題部には抵当権だけが記録される", "権利部には所在・地番だけが記録される", "土地と建物を一つの登記記録にまとめる"],
      proposedAnswerIndex: 0,
    ...
    },
    {
      ...
      choices: ["甲区には抵当権、乙区には所有権だけを記録する", "甲区には所有権に関する事項、乙区には抵当権など所有権以外の権利に関する事項を記録する", "甲区と乙区には同じ事項を記録する", "権利部には権利関係を記録しない"],
      proposedAnswerIndex: 1,
