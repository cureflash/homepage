(() => {
  ...
  const mappings = [
    ...
    { questionId: "takken-q-88-002", conceptId: "takken-concept-landform-disaster-risk", knowledgeRefs: ["takken-k-landform-disaster-risk-classification-indicates-hazard", "takken-k-landform-disaster-risk-liquefaction-landforms", "takken-k-landform-disaster-risk-flood-inundation-landforms"], sourceQuestionValidationStatus: "verified" }
  ];
  ...
  if (mappings.length !== 146) throw new Error(`Expected 146 mapped questions through unit 88 q88-002, got ${mappings.length}`);
