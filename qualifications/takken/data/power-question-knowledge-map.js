(() => {
  ...
  const mappings = [
    ...
    { questionId: "takken-q-83-002", conceptId: "takken-concept-real-estate-transfer-income", knowledgeRefs: ["takken-k-real-estate-transfer-income-january1-reference-date", "takken-k-real-estate-transfer-income-long-term-over-five-years"], sourceQuestionValidationStatus: "verified" }
  ];
  ...
  const knownKnowledgeIds = new Set([
    ...
    "takken-k-real-estate-transfer-income-separate-taxation", "takken-k-real-estate-transfer-income-january1-reference-date", "takken-k-real-estate-transfer-income-long-term-over-five-years"
  ]);
