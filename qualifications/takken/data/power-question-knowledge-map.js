(() => {
  ...
  const mappings = [
    ...
    { questionId: "takken-q-60-001", conceptId: "takken-concept-real-estate-registration-record", knowledgeRefs: ["takken-k-real-estate-registration-record-title-section", "takken-k-real-estate-registration-record-rights-section"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-60-002", conceptId: "takken-concept-real-estate-registration-record", knowledgeRefs: ["takken-k-real-estate-registration-record-section-a-ownership", "takken-k-real-estate-registration-record-section-b-nonownership"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-61-001", conceptId: "takken-concept-city-quasi-planning-area", knowledgeRefs: ["takken-k-city-quasi-planning-area-city-authority-prefecture", "takken-k-city-quasi-planning-area-city-integrated-need"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-61-002", conceptId: "takken-concept-city-quasi-planning-area", knowledgeRefs: ["takken-k-city-quasi-planning-area-quasi-outside-city-area", "takken-k-city-quasi-planning-area-quasi-land-use-risk"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-62-001", conceptId: "takken-concept-area-division", knowledgeRefs: ["takken-k-area-division-purpose-and-two-zones"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-62-002", conceptId: "takken-concept-area-division", knowledgeRefs: ["takken-k-area-division-urbanization-existing-built-up", "takken-k-area-division-urbanization-ten-years", "takken-k-area-division-control-suppress-urbanization"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-63-001", conceptId: "takken-concept-use-districts", knowledgeRefs: ["takken-k-use-districts-regional-district"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-63-002", conceptId: "takken-concept-use-districts", knowledgeRefs: ["takken-k-use-districts-building-use-restrictions"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-64-001", conceptId: "takken-concept-city-planning-decision", knowledgeRefs: ["takken-k-city-planning-decision-prefecture-specified-plans", "takken-k-city-planning-decision-municipality-other-plans"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-64-002", conceptId: "takken-concept-city-planning-project", knowledgeRefs: ["takken-k-city-planning-decision-project-municipality-authorization", "takken-k-city-planning-decision-project-prefecture-authorization", "takken-k-city-planning-decision-project-national-approval", "takken-k-city-planning-decision-project-private-authorization"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-65-001", conceptId: "takken-concept-development-permission", knowledgeRefs: ["takken-k-development-permission-city-quasi-general-rule", "takken-k-development-permission-authority"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-65-002", conceptId: "takken-concept-development-permission", knowledgeRefs: ["takken-k-development-permission-public-interest-building-exemption"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-66-001", conceptId: "takken-concept-development-completion", knowledgeRefs: ["takken-k-development-completion-completion-notice"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-66-002", conceptId: "takken-concept-development-completion", knowledgeRefs: ["takken-k-development-completion-conformity-inspection", "takken-k-development-completion-inspection-certificate", "takken-k-development-completion-public-notice"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-67-001", conceptId: "takken-concept-building-confirmation", knowledgeRefs: ["takken-k-building-confirmation-before-start"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-67-002", conceptId: "takken-concept-building-confirmation", knowledgeRefs: ["takken-k-building-confirmation-building-official", "takken-k-building-confirmation-designated-body", "takken-k-building-confirmation-confirmation-certificate"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-68-001", conceptId: "takken-concept-roads-frontage", knowledgeRefs: ["takken-k-roads-frontage-road-width-principle"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-68-002", conceptId: "takken-concept-roads-frontage", knowledgeRefs: ["takken-k-roads-frontage-frontage-two-meters"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-69-001", conceptId: "takken-concept-building-coverage-ratio", knowledgeRefs: ["takken-k-building-coverage-ratio-definition"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-69-002", conceptId: "takken-concept-building-coverage-ratio", knowledgeRefs: ["takken-k-building-coverage-ratio-fire-relaxation", "takken-k-building-coverage-ratio-corner-relaxation"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-70-001", conceptId: "takken-concept-floor-area-ratio", knowledgeRefs: ["takken-k-floor-area-ratio-definition"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-70-002", conceptId: "takken-concept-floor-area-ratio", knowledgeRefs: ["takken-k-floor-area-ratio-front-road-under-twelve"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-71-001", conceptId: "takken-concept-setback-height-restrictions", knowledgeRefs: ["takken-k-setback-height-three-slope-types"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-71-002", conceptId: "takken-concept-shadow-restrictions", knowledgeRefs: ["takken-k-shadow-restrictions-ordinance-designated-scope"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-72-001", conceptId: "takken-concept-fire-prevention-zones", knowledgeRefs: ["takken-k-fire-prevention-zones-regional-district-status"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-72-002", conceptId: "takken-concept-fire-prevention-zones", knowledgeRefs: ["takken-k-fire-prevention-zones-requirement-varies-by-zone-scale"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-73-001", conceptId: "takken-concept-national-land-use-notification", knowledgeRefs: ["takken-k-national-land-use-notification-rights-acquirer"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-73-002", conceptId: "takken-concept-national-land-use-notification", knowledgeRefs: ["takken-k-national-land-use-notification-deadline-two-weeks", "takken-k-national-land-use-notification-route-municipality-prefecture"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-74-001", conceptId: "takken-concept-farmland-article3", knowledgeRefs: ["takken-k-farmland-article3-agricultural-committee-permit"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-74-002", conceptId: "takken-concept-farmland-article3", knowledgeRefs: ["takken-k-farmland-article3-unpermitted-act-invalid"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-75-001", conceptId: "takken-concept-farmland-article4", knowledgeRefs: ["takken-k-farmland-article4-self-conversion-scope"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-75-002", conceptId: "takken-concept-farmland-article5", knowledgeRefs: ["takken-k-farmland-article5-rights-transfer-conversion-scope", "takken-k-farmland-article5-vs-article4-rights-transfer"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-76-001", conceptId: "takken-concept-provisional-replotting", knowledgeRefs: ["takken-k-provisional-replotting-designation-authority", "takken-k-provisional-replotting-designation-grounds"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-76-002", conceptId: "takken-concept-replotting-disposition", knowledgeRefs: ["takken-k-replotting-disposition-effect-start-next-day"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-77-001", conceptId: "takken-concept-embankment-regulation", knowledgeRefs: ["takken-k-embankment-regulation-zone-designation-authority"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-77-002", conceptId: "takken-concept-embankment-regulation", knowledgeRefs: ["takken-k-embankment-regulation-takuzo-zone-permit", "takken-k-embankment-regulation-special-zone-permit", "takken-k-embankment-regulation-covered-works"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-78-001", conceptId: "takken-concept-legal-permit-notification-comparison", knowledgeRefs: ["takken-k-legal-comparison-development-prior-permit", "takken-k-legal-comparison-development-target-action"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-78-002", conceptId: "takken-concept-legal-permit-notification-comparison", knowledgeRefs: ["takken-k-legal-comparison-national-land-post-notification-actor"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-79-001", conceptId: "takken-concept-real-estate-acquisition-tax", knowledgeRefs: ["takken-k-real-estate-acquisition-tax-prefectural-taxpayer", "takken-k-real-estate-acquisition-tax-acquisition-regardless-registration-payment", "takken-k-real-estate-acquisition-tax-inheritance-nontaxable"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-79-002", conceptId: "takken-concept-real-estate-acquisition-tax", knowledgeRefs: ["takken-k-real-estate-acquisition-tax-base-registered-value", "takken-k-real-estate-acquisition-tax-land-half-tax-base", "takken-k-real-estate-acquisition-tax-rates-20260401", "takken-k-real-estate-acquisition-tax-exemption-thresholds-20260401"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-80-001", conceptId: "takken-concept-fixed-asset-tax", knowledgeRefs: ["takken-k-fixed-asset-tax-municipal-owner-tax"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-80-002", conceptId: "takken-concept-fixed-asset-tax", knowledgeRefs: ["takken-k-fixed-asset-tax-assessment-date-january1"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-81-001", conceptId: "takken-concept-registration-license-tax", knowledgeRefs: ["takken-k-registration-license-tax-taxable-registration"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-81-002", conceptId: "takken-concept-registration-license-tax", knowledgeRefs: ["takken-k-registration-license-tax-taxpayer-recipient"], sourceQuestionValidationStatus: "verified" },
    ...
    { questionId: "takken-q-85-001", conceptId: "takken-concept-real-estate-appraisal-methods", knowledgeRefs: ["takken-k-real-estate-appraisal-methods-three-approaches"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-85-002", conceptId: "takken-concept-real-estate-appraisal-methods", knowledgeRefs: ["takken-k-real-estate-appraisal-methods-three-basic-methods"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-86-001", conceptId: "takken-concept-flat35-securitization", knowledgeRefs: ["takken-k-flat35-securitization-all-period-fixed"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-86-002", conceptId: "takken-concept-flat35-securitization", knowledgeRefs: ["takken-k-flat35-securitization-jhf-purchases-receivable"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-87-001", conceptId: "takken-concept-real-estate-advertising-rules", knowledgeRefs: ["takken-k-real-estate-advertising-rules-misleading-display-prohibited"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-87-002", conceptId: "takken-concept-real-estate-advertising-rules", knowledgeRefs: ["takken-k-real-estate-advertising-rules-misleading-display-prohibited"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-88-001", conceptId: "takken-concept-landform-disaster-risk", knowledgeRefs: ["takken-k-landform-disaster-risk-land-condition-map-classifications", "takken-k-landform-disaster-risk-land-condition-map-purpose"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-88-002", conceptId: "takken-concept-landform-disaster-risk", knowledgeRefs: ["takken-k-landform-disaster-risk-classification-indicates-hazard"], sourceQuestionValidationStatus: "verified" },
    { questionId: "takken-q-89-001", conceptId: "takken-concept-housing-market-statistics", knowledgeRefs: ["takken-k-housing-market-statistics-2026-land-price-five-year-rise"], sourceQuestionValidationStatus: "verified" }
  ];
  ...
  if (mappings.length !== 147) throw new Error(`Expected 147 mapped questions through unit 89 q89-001, got ${mappings.length}`);
  ...
  if (!questionIds.has("takken-q-85-001") || !questionIds.has("takken-q-85-002")) throw new Error("Real-estate-appraisal-methods source question mappings are missing");
  if (!questionIds.has("takken-q-86-001") || !questionIds.has("takken-q-86-002")) throw new Error("Flat35-securitization source question mappings are missing");
  if (!questionIds.has("takken-q-87-001") || !questionIds.has("takken-q-87-002")) throw new Error("Real-estate-advertising-rules source question mappings are missing");
  if (!questionIds.has("takken-q-88-001") || !questionIds.has("takken-q-88-002")) throw new Error("Landform-disaster-risk source question mappings are missing");
  if (!questionIds.has("takken-q-89-001")) throw new Error("Housing-market-statistics source question mapping is missing");
