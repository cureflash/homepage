(() => {
  ...
  const mappings = [
    ...
    { questionId: "takken-q-64-002", conceptId: "takken-concept-city-planning-decision", knowledgeRefs: ["takken-k-city-planning-decision-project-municipality-authorization", "takken-k-city-planning-decision-project-prefecture-authorization", "takken-k-city-planning-decision-project-national-approval", "takken-k-city-planning-decision-project-private-authorization"], sourceQuestionValidationStatus: "verified" }
  ];
  ...
  if (mappings.length !== 98) throw new Error(`Expected 98 mapped questions through unit 64 q64-002, got ${mappings.length}`);
  ...
  if (!questionIds.has("takken-q-64-001") || !questionIds.has("takken-q-64-002")) throw new Error("City-planning-decision source question mappings are missing");
