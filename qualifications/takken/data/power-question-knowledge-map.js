(() => {
  ...
  const mappings = [
    ...
    { questionId: "takken-q-57-001", conceptId: "takken-concept-inheritance-deliberation", knowledgeRefs: ["takken-k-inheritance-deliberation-three-month-period", "takken-k-inheritance-deliberation-three-options"], sourceQuestionValidationStatus: "verified" },
  ...
  if (mappings.length !== 84) throw new Error(`Expected 84 mapped questions through unit 57 q57-002, got ${mappings.length}`);
