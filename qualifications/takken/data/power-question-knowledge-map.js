(() => {
  ...
  const mappings = [
    ...
    },
    {
      ...
      knowledgeRefs: [
        "takken-k-license-disqualification-revocation-five-years",
        "takken-k-license-disqualification-criminal-penalty-five-years",
        "takken-k-license-disqualification-improper-conduct-five-years"
      ],
      sourceQuestionValidationStatus: "verified"
    }
  ];
