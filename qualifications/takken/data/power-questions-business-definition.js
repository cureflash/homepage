(() => {
  ...
  const rows = [
    ...
    ["013", ["takken-k-business-definition-self-sale-exchange"], "Fは自己所有の土地を複数区画に分け、自ら買主と売買契約を締結して販売する事業を行う。宅地建物取引業の定義との関係で最も適切なものはどれか。", ["自分の土地の売却なので定義上は含まれない", "自ら宅地の売買を業として行うため定義上含まれる", "媒介業者を使わない限り定義上含まれない", "貸借ではないので定義上含まれない"], 1, "自己所有物であっても、宅地または建物を自ら売買する行為を業として行えば宅建業の定義に含まれる。", ["自己所有であることは自ら売買を除外する理由ではない。", "正しい。自ら宅地売買を業として行う場合は含まれる。", "媒介業者の利用有無は自ら売買の該当性を左右しない。", "売買は定義の対象である。"]],
    ...
    ["024", ["takken-k-business-definition-self-sale-exchange", "takken-k-business-definition-agency-brokerage"], "M社は、自己所有建物を交換する事業と、他人所有建物の貸借を媒介する事業を行っている。宅地建物取引業の定義上、正しいものはどれか。", ["前者だけが含まれる", "後者だけが含まれる", "両方とも含まれる", "両方とも含まれない"], 2, "自ら建物を交換する行為を業とする場合も、他人の建物の貸借を媒介する行為を業とする場合も、いずれも宅建業に含まれる。", ["貸借媒介も含まれる。", "自ら交換も含まれる。", "正しい。両方とも宅建業に含まれる。", "両方とも法2条2号の対象類型である。"]],
