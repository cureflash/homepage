(() => {
  ...
  const Q = [
    ...
    },
    {
      ...
      choices: [
        "建築物の延べ面積の敷地面積に対する割合である",
        "建築物の高さの敷地幅に対する割合である",
        "建築物の建築面積の敷地面積に対する割合である",
        "敷地面積の前面道路幅員に対する割合である"
      ],
    ...
    },
    {
      ...
      choices: [
        "防火地域内であっても建ぺい率の緩和は一切ない",
        "角地であっても建ぺい率の緩和は一切ない",
        "用途地域にかかわらず全国一律の上限だけが適用される",
        "一定の防火地域内の耐火建築物等や角地などでは、緩和・適用除外が生じる場合がある"
      ],
    ...
    },
    {
      ...
      choices: [
        "指定容積率だけを見ればよく、道路幅員は一切関係しない",
        "道路幅員に一定の数値を乗じて得た割合による制限も適用される",
        "容積率の制限はなくなる",
        "建ぺい率と同じ数値が自動的に容積率となる"
      ],
      proposedAnswerIndex: 1,
    ...
    },
    {
      ...
      choices: [
        "全国のすべての建築物に一律に適用される",
        "用途地域と無関係に必ず適用される",
        "都市計画法だけに定められ、建築基準法には規定がない",
        "条例で指定する区域内の一定の建築物について適用される"
      ],
      proposedAnswerIndex: 3,
    ...
    },
    {
      ...
      choices: [
        "区域内であっても防火性能に関する規制はない",
        "建築物の規模等に応じた防火性能が求められる",
        "すべて木造でなければならない",
        "用途地域が商業地域の場合に限り規制される"
      ],
      proposedAnswerIndex: 1,
    ...
    },
    {
      ...
      choices: [
        "契約締結日から1週間以内に国土交通大臣へ直接届け出る",
        "登記完了日から1か月以内に法務局へ届け出る",
        "契約締結日から30日以内に市町村長へ届け出て完了する",
        "契約締結日から2週間以内に、市町村長を経由して都道府県知事へ届け出る"
      ],
      proposedAnswerIndex: 3,
    ...
    },
    {
      ...
      choices: [
        "施行者は、事業施行上必要がある場合等に仮換地を指定できる",
        "仮換地は裁判所だけが指定できる",
        "仮換地は換地処分後に初めて指定できる",
        "仮換地制度は土地区画整理法には存在しない"
      ],
      proposedAnswerIndex: 0,
    ...
    },
    {
      ...
      choices: [
        "農地の集約化だけを目的とする",
        "土地価格の上昇を抑えることだけを目的とする",
        "盛土等に伴う災害を防止するため、都道府県知事等が規制区域を指定する",
        "建築物の用途だけを制限する"
      ],
      proposedAnswerIndex: 2,
