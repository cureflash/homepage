...
const batch = JSON.parse(await readFile(new URL('../data/grade1-authoring-harmony-chevreul-p025-0001-0004.json', import.meta.url), 'utf8'));
const priorFiles = [
...
test('Grade 1 p025 Chevreul batch remains verified, source-bound, nonvisual, globally unique and balanced', () => {
  ...
  for (const q of batch.questions) {
    ...
    assert.equal(q.sourceRefs.every((s) => s === 'aft_grade1_sample_chevreul'), true);
