...
const fileName = 'grade1-authoring-woven-knitted-p135-0001-0004.json';
...
test('Grade 1 p135 woven-knitted batch remains verified, source-bound, nonvisual and globally unique', () => {
  assert.equal(batch.grade,1); assert.equal(batch.skill.id,'pc1.fashion.woven_knitted_p135'); assert.equal(batch.questions.length,4);
