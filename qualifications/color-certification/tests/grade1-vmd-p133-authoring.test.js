...
const fileName = 'grade1-authoring-vmd-p133-0001-0004.json';
...
test('Grade 1 p133 VMD batch remains verified, source-bound, nonvisual and globally unique', () => {
  assert.equal(batch.grade,1); assert.equal(batch.skill.id,'pc1.fashion.vmd_p133'); assert.equal(batch.questions.length,4);
