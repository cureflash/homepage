...
const fileName = 'grade1-authoring-light-color-perception-p152-0001-0004.json';
...
test('Grade 1 p152 color-perception batch remains verified, official-sample-bound, nonvisual and globally unique', () => {
  assert.equal(batch.grade,1); assert.equal(batch.skill.id,'pc1.light.color_perception_p152'); assert.equal(batch.questions.length,4);
