...
const fileName = 'grade1-authoring-landscape-color-attributes-p146-0001-0004.json';
...
test('Grade 1 p146 landscape-color-attributes batch remains verified, source-bound, nonvisual and globally unique', () => {
  assert.equal(batch.grade,1); assert.equal(batch.skill.id,'pc1.landscape.color_attributes_p146'); assert.equal(batch.questions.length,4);
