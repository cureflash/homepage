...
const fileName = 'grade1-authoring-fashion-color-information-p129-0001-0004.json';
...
test('Grade 1 p129 fashion-color-information batch remains verified, source-bound, nonvisual and globally unique', () => {
  assert.equal(batch.grade,1); assert.equal(batch.skill.id,'pc1.fashion.color_information_p129'); assert.equal(batch.questions.length,4);
