...
const batch = JSON.parse(await readFile(new URL('../data/grade2-authoring-landscape-element-examples-0001-0012.json', import.meta.url), 'utf8'));
...
test('Grade 2 Landscape p117 element-examples batch is independently verified, nonvisual, balanced and runtime-promoted record-identically', () => {
  ...
  for (const q of batch.questions) {
    ...
    assert.equal(q.taxonomyPath, 'grade2/landscape/element_examples');
