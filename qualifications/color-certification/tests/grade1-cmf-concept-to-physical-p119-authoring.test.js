...
const fileName = 'grade1-authoring-cmf-concept-to-physical-p119-0001-0004.json';
...
test('Grade 1 p119 CMF batch remains verified, AFT-source-bound, nonvisual and globally unique', () => {
  assert.equal(batch.grade,1); assert.equal(batch.skill.id,'pc1.business.cmf_concept_to_physical_p119'); assert.equal(batch.questions.length,4);
