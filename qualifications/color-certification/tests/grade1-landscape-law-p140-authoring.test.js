...
const fileName = 'grade1-authoring-landscape-law-p140-0001-0004.json';
...
test('Grade 1 p140 landscape-law batch remains verified, source-bound, nonvisual and globally unique', () => {
  assert.equal(batch.grade,1); assert.equal(batch.skill.id,'pc1.landscape.landscape_law_p140'); assert.equal(batch.questions.length,4);
