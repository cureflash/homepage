...
const batch = JSON.parse(await readFile(new URL('../data/grade2-authoring-landscape-long-lifecycle-color-0001-0012.json', import.meta.url), 'utf8'));
...
test('Grade 2 Landscape p120 long-lifecycle batch is independently verified, nonvisual, balanced and not yet runtime-promoted', () => {
  ...
  for (const q of batch.questions) {
    ...
    assert.equal(q.taxonomyPath, 'grade2/landscape/long_lifecycle_color');
