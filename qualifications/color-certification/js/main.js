...
import { CORRECT_QUIZ_SOUND_URL, WRONG_QUIZ_SOUND_URL } from './quiz-sounds.js?v=20260904-quiz-sounds-v1';
...
const correctSound = new Audio(CORRECT_QUIZ_SOUND_URL);
const wrongSound = new Audio(WRONG_QUIZ_SOUND_URL);
...
renderer.setAnswerHandler((selectedIndex) => {
  ...
  playFeedbackSound(selectedIndex === question.correctIndex);
  renderer.showResult({
    question,
    selectedIndex,
