  ...
  const unit = {
    ...
    facts: [
      ...
      },
      {
        ...
        claim: "1871年の廃藩置県で藩は廃止され、知藩事に代わって中央政府が任命する府知事・県知事（のち県令）が各府県の行政を担う仕組みに改められた。",
    ...
    sections: [
      {
        ...
        sentences: [
          {
            id: "bakumatsu-01",
            template: "1853年、アメリカ東インド艦隊司令長官{{ペリー}}が4隻の艦船を率いて{{浦賀}}沖に来航し、久里浜で幕府側に大統領の国書を渡した。",
            terms: ["ペリー", "浦賀"],
            importance: "A",
            sources: ["national-archives-blackships", "mext-social-commentary"],
            factcheckStatus: "verified"
          ...
          {
            id: "bakumatsu-02",
            template: "1854年、幕府はアメリカと{{日米和親条約}}を結び、{{下田}}・{{箱館}}を開くなど対外政策を転換した。この条約には通商の条項はなかった。",
            terms: ["日米和親条約", "下田", "箱館"],
            importance: "A",
            sources: ["national-archives-treaties", "mext-social-commentary"],
            factcheckStatus: "verified"
      ...
      },
      {
        ...
        sentences: [
          {
            id: "bakumatsu-04",
            template: "政治対立が深まる中、1866年に{{薩摩藩}}と{{長州藩}}の間で薩長同盟が成立し、その後、倒幕を目指す動きが強まった。",
            terms: ["薩摩藩", "長州藩"],
            importance: "A",
            sources: ["mext-social-commentary", "national-archives-bakumatsu-timeline"],
            factcheckStatus: "verified"
          ...
          {
            id: "bakumatsu-05",
            template: "1867年、将軍{{徳川慶喜}}は政権を朝廷に返す{{大政奉還}}を行い、同じ年12月に{{王政復古の大号令}}が発せられた。",
          ...
          {
            id: "bakumatsu-06",
            template: "1868年の鳥羽・伏見の戦いから{{戊辰戦争}}が始まり、新政府軍と旧幕府側の戦いは1869年に箱館で旧幕府軍が降伏するまで続いた。",
            terms: ["戊辰戦争"],
            importance: "B",
            sources: ["national-archives-bakumatsu-timeline", "national-archives-ayumi"],
            factcheckStatus: "verified"
      ...
      },
      {
        ...
        sentences: [
          ...
          {
            id: "bakumatsu-08",
            template: "1871年の{{廃藩置県}}で藩は廃止され、知藩事に代わって中央政府が任命する府知事・県知事（のち県令）が各府県の行政を担う仕組みに改められた。",
            terms: ["廃藩置県"],
            importance: "A",
            sources: ["mext-social-commentary", "national-archives-ayumi", "national-archives-pamphlet"],
            factcheckStatus: "verified"
    ...
    images: [
      {
        ...
        credit: "W.T. Petris / Sarony & Co. / Library of Congress / Wikimedia Commons",
