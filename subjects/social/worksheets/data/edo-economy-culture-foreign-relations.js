  ...
  const unit = {
    ...
    facts: [
      ...
      },
      {
        ...
        claim: "蝦夷地ではアイヌの人々が海産物などを交易し、松前藩はアイヌとの交易を統制した。",
    ...
    sections: [
      ...
      },
      {
        ...
        sentences: [
          ...
          {
            id: "edo-foreign-04",
            template: "蝦夷地では{{アイヌ}}の人々が海産物などを交易し、{{松前藩}}はアイヌとの交易を統制した。",
            terms: ["アイヌ", "松前藩"],
            importance: "A",
            sources: ["mext-social-commentary", "rekihaku-room3", "national-ainu-trade"],
            factcheckStatus: "verified"
    ...
    images: [
      {
        ...
        note: "1844〜1847年の錦絵。三条大橋からの眺めと往来を描いた東海道関連資料",
      ...
      },
      {
        ...
        label: "出島と長崎港の交易風景",
        note: "1800〜1825年の絵画。出島周辺にオランダ船と中国の交易船が描かれている",
        ...
        credit: "作者不詳の絵画 / British Museum / PHGCOM（撮影） / Wikimedia Commons",
