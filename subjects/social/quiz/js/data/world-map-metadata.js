export const WORLD_MERCATOR_MAP_SOURCE = Object.freeze({
  ...
  delivery: "6 pre-generated local major-region SVG files",
  runtimeExternalDependency: false,
  generator: "scripts/build_social_world_maps.py",
  manifest: "assets/maps/world/manifest.json",
  note: "Natural Earth 1:50m country geometry is projected to Web Mercator and grouped into Asia, Europe, Africa, North America, South America, and Oceania at build time. The browser loads only the selected local major-region SVG."
});
