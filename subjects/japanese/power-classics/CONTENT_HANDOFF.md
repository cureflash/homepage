...
- completed: 125/200
- next ID: `kobun_aux_ki_keri_meaning_0126`
- next safe checkpoint: 0126〜0150（25問）

## Totals

1225 generated / 1225 checked / 1225 verified / 0 needs_revision / 0 rejected / pending 0.

## Latest QA

`kobun.aux.ki_keri.meaning` 0101〜0125をstem＋choicesのみから独立再解答し25/25 verified。正答位置A/B/C/D = 7/6/6/6、stem完全重複0、batch内最大類似度0.767（0.94以上0件）。「き」の過去、物語・伝承・昔の習慣文脈での「けり」の過去、眼前の気づき・感動・和歌文脈での「けり」の詠嘆を確認した。
