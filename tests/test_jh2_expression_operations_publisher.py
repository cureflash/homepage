...
from scripts.publish_jh2_expression_operations import (
    PROBLEM_COUNT,
    SEEDS,
    SKILLS,
    generate,
...
def main():
    ...
    source_text = (ROOT / 'scripts/publish_jh2_expression_operations.py').read_text(encoding='utf-8')
    assert 'str(index + 1)' in source_text
    assert 'colors.red' in source_text
    print('junior-high grade 2 expression-operation publisher tests: OK')
